...
<body>
      ...
      <div class="left">
        ...
        <div class="top_left">
          <div class="hour">
            ...
            <h1 class="hour_number"><?php echo e($today); ?></h1>
            <h2 class="hour_hour">hours</h2>
          </div>
          <div class="hour">
            <h2 class="hour_title">Month</h2>
            <h1 class="hour_number"><?php echo e($month); ?></h1>
            <h2 class="hour_hour">hours</h2>
          </div>
          <div class="hour">
            <h2 class="hour_title">Total</h2>
            <h1 class="hour_number"><?php echo e($total); ?></h1>
            <h2 class="hour_hour">hours</h2>
          </div>
        </div>
        <!-- BOTTOM LEFT -->
  ...
  const myColumnChart = new Chart(column, {
      ...
      data: {
          ...
          datasets: [{
              data: [
                <?php $__currentLoopData = $bar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bar_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php echo e($bar_data->sum); ?>,
  ...
  const myFirstDonutChart = new Chart(donut1, {
      ...
      data: {
          ...
          datasets: [{
              ...
              data: [
                <?php $__currentLoopData = $lang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php echo e($lang_data->sum); ?>,
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
              ],
              backgroundColor: [
                "#0f70bd",
  ...
  const mySecondDonutChart = new Chart(donut2, {
      ...
      data: {
          ...
          datasets: [{
              data: [
                <?php $__currentLoopData = $content; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $content_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php echo e($content_data->sum); ?>,
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
              ],
              backgroundColor: [
                '#0445ec',
